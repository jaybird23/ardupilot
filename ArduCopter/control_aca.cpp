...
/*
 * control_aca.pde - init and run calls for ACA flight mode
 */

// aca_init - initialise ACA controller
bool Copter::aca_init(bool ignore_checks)
{
...
// aca_run - runs the brake controller
